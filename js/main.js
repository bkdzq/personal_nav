...
function init(){
    ...
    let hash = {
        q : 'qq.com',
        w : 'wangdoc.com',
        e : 'www.bilibili.com/video/BV1TF411w7Hr/',
        r : 'bilibili.com/video/BV1QK411S7xg/',
        t : 'tgideas.qq.com/doc/',
        y : 'youtube.com',
        i : 'iciba.com',
        o : 'bilibili.com/video/BV17W4y1b7Gr/',
        p : 'bilibili.com/video/BV1m8411a763/',
        a : 'bilibili.com/video/BV1wa411N7pM/',
        s : 'segmentfault.com',
        d : 'dribbble.com',
        f : 'bilibili.com/video/BV1aV4y1G7T2/',
        g : 'github.com',
        h : 'bilibili.com/video/BV1MW4y1E7ZL/',
        j : 'juejin.im',
        k : 'ke.qq.com',
        l : 'bilibili.com/video/BV1Kt4y1V7hZ/',
        z : 'zhihu.com',
        x : 'xiedaimala.com',
        c : 'csdn.net',
        v : 'bilibili.com/video/BV1Qd4y117R4/',
        b : 'bilibili.com/video/BV1fe4y1J7mr/',
        n : undefined,
        m : 'mail.163.com'
    }
...
function listenToUser(hash) {
    ...
    searchBtn.onclick = function (e) {
        ...
        switch (engin) {
            case 'baidu':
                // https://www.sogou.com/web?query=me&_asf=www.sogou.com&_ast=&w=01019900&p=40040100&ie=utf8&from=index-nologin&s_from=index&sut=3523&sst0=1668966198949&lkt=2%2C1668966198473%2C1668966198540&sugsuv=1648550248931782&sugtime=1668966198949
                window.open("https://www.baidu.com/s?wd=" + searchContent, '_blank');
                // window.open("https://www.sogou.com/web?query=" + searchContent, '_blank');
                break;
            case 'google':
    ...
    document.onkeypress = function (e) {
        ...
        if (!ifInputting) {
            if (website === undefined) {
                alert('please edit the corresponding link and try again!')
            } else {
                console.log(1);
                window.open('http://' + website, "_blank");
            }
